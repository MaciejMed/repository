...
async def help(interaction:discord.Integration):
    ...
    embed.add_field(name="/hello", value="Wita się z użytkownikiem", inline=False)
    embed.add_field(name="/kostka", value="Prosty rzut kostką", inline=False)
    embed.add_field(name="/dungeon", value="Generuje loch z emotikon", inline=False)
    embed.add_field(name="/customdung", value="Generuje loch z wybranych emotikon", inline=False)
    embed.add_field(name="/presetdung", value="Generuje loch z wybranego zestawu emotikon", inline=False)
    embed.add_field(name="/roadgen", value="Generuje dróżkę z emotikon", inline=False)
    embed.add_field(name="/rzutpro", value="Rzuca kostką z dodatkowymi funkcjami", inline=False)
    embed.add_field(name="/namegen", value="Generuje losowe imię z wybranej listy", inline=False)
    embed.add_field(name="/addname", value="Dodaje imię do listy", inline=False)
    embed.add_field(name="/remname", value="Usuwa imię z listy", inline=False)
    embed.add_field(name="/namelist", value="Wyświetla wszystkie imiona z wybranej listy", inline=False)
    embed.add_field(name="/createcharacter", value="Tworzy kartę postaci", inline=False)
    embed.add_field(name="/karta", value="Wyświetla kartę postaci wybranego użytkownika", inline=False)
    embed.add_field(name="/modkarty", value="Modyfikuje wybrany element karty", inline=False)
    embed.add_field(name="/modyfikujeq", value="Modyfikuje ekwipunek", inline=False)
    embed.add_field(name="/pokazeq", value="Pokazuje ekwipunek wybranego gracza", inline=False)
    embed.add_field(name="/przedmiot", value="Pokazuje informacje o wybranym przedmiocie", inline=False)
    embed.add_field(name="/dodaj", value="Dodaje do siebie dwie liczby", inline=False)
    embed.add_field(name="/odejmij", value="Odejmuje jedną liczbę od drugiej", inline=False)
    embed.add_field(name="/pomnoz", value="Mnoży przez siebie dwie liczby", inline=False)
    embed.add_field(name="/podziel", value="Dzieli jedną liczbę przez drugą", inline=False)
    embed.add_field(name="/pierwiastek", value="Pierwiastkuje podaną liczbę", inline=False)
